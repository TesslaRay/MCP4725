 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.18.0/apps/Adafruit_MCP4725/esp32/build_contexts/build_ctx_606505461/build/gen/ /mongoose-os/src/mgos_debug_udp_config.yaml /mongoose-os/platforms/esp32/src/esp32_sys_config.yaml /data/fwbuild-volumes/2.18.0/apps/Adafruit_MCP4725/esp32/build_contexts/build_ctx_606505461/build/gen/mos_conf_schema.yml
 */
...
const struct mgos_conf_entry mgos_config_schema_[52] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 51},
